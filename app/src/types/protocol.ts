...
export type Type7 = "open_app";
/**
 * @minItems 1
 */
export type Command = [string, ...string[]];
export type Type8 = "open_path";
export type Path = string;
export type Type9 = "open_url";
export type Url = string;
export type Type10 = "hotkey";
/**
 * @minItems 1
 */
...
export interface Protocol {
  client: HelloMessage | DeckGetMessage | ActionTriggerMessage | PingMessage;
